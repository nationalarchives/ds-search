...
IP_STAFFIN_RANGES = [
    ...
    {"Address": "10.96.0.0/13"},  # Description: UPTOS servers- all NA- servers
    {"Address": "10.104.0.0/13"},  # Description: Staff Edge User Access
    {"Address": "10.95.48.0/24"},  # Description: TNA WVD
    {
        "Address": "172.31.0.0/21"
    },  # Description: BIA Excluding web servers and load balanced services
    {"Address": "10.252.16.0/21"},  # Description: Staff Remote Access
    {"Address": "10.252.21.0/24"},  # Description: F5 VPN Staff Remote Access
    {"Address": "10.114.1.0/24"},  # Description: F5 BIG-IP
]
...
IP_ONSITE_RANGES = [
    ...
    {"Address": "167.98.93.94/32"},  # Description: Public Wi-Fi
    {"Address": "10.120.0.0/13"},  # Description: Public Edge User Access
    {
