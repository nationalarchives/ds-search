<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template mode="PrisonerInterview" match="emph[@altrender='doctype']">
	</xsl:template>


	<!-- Display lastname, firstname -->
	<xsl:template mode="PrisonerInterview" match="persname">
		<tr class="medalRow">
			<td class="medalplain" width="25%"><xsl:text disable-output-escaping="yes">Name(s): </xsl:text></td>
			<td class="medalplain" width="35%"><xsl:value-of select="emph[@altrender='surname']/text()"/>
	...
	<!-- add page -->
	<xsl:template mode="PrisonerInterview" match="emph[@altrender='page']">
			<tr class="medalRow">
	...
	<!-- add Corps -->
	<xsl:template mode="PrisonerInterview" match="corpname">
			<tr class="medalRow">
	...
	<!-- add Rank -->
	<xsl:template mode="PrisonerInterview" match="emph[@altrender='rank']">
			<tr class="medalRow">
	...
	<!-- add Regiment No -->
	<xsl:template mode="PrisonerInterview" match="emph[@altrender='regno']">
			<tr class="medalRow">
	...
	<xsl:template mode="PrisonerInterview" match="emph[@altrender='people']">
	 <tr class="medalRow">
	...
	<xsl:template mode="PrisonerInterview" match="emph[@altrender='orgsmentioned']">
	 <tr class="medalRow">
