<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template mode="Wrns" match="emph[@altrender='doctype']">
	</xsl:template>


	<!-- Display lastname, firstname -->
	<xsl:template mode="Wrns" match="persname">
		<tr class="medalRow">
		<td class="medalplain" width="30%"><xsl:text disable-output-escaping="yes">Service record of </xsl:text></td>
	...
	<xsl:template mode="Wrns" match="emph[@altrender='num']">
			<tr class="medalRow">
	...
	<!-- add Date of will -->
	<xsl:template mode="Wrns" match="emph[@altrender='rank']">
			<tr class="medalRow">
	...
	<!-- add Date of will -->
	<xsl:template mode="Wrns" match="emph[@altrender='date']">
			<tr class="medalRow">
