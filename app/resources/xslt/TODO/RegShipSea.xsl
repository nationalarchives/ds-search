<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template mode="ShippingSeamen" match="emph[@altrender='doctype']">
	</xsl:template>

	<!-- Display Ship Name -->
	<xsl:template mode="ShippingSeamen" match="emph[@altrender='name']">
			<tr class="medalRow">
				<td class="medalheader" width="20%"> Ship Name: </td>
				<td class="medalplain" width="20%"><xsl:value-of select="text()" />
				</td></tr>
	</xsl:template>
	

	<!-- Display Ship Name -->
	<xsl:template mode="ShippingSeamen" match="emph[@altrender='name2']">
			<tr class="medalRow">
	...
	<!-- add  age -->
	<xsl:template mode="ShippingSeamen" match="emph[@altrender='size']">
			<tr class="medalRow">
	...
	<!-- add Corps -->
	<xsl:template mode="ShippingSeamen" match="geogname">
			<tr class="medalRow">
	...
	<!-- add  age -->
	<xsl:template mode="ShippingSeamen" match="emph[@altrender='card']">
			<tr class="medalRow">
