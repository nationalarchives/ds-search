<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template mode="RNOfficer" match="emph[@altrender='doctype']">
	</xsl:template>

	<!-- Display lastname, firstname -->
	<xsl:template mode="RNOfficer" match="persname">
		<tr class="medalRow">
	...
	<!-- add  age -->
	<xsl:template mode="RNOfficer" match="emph[@altrender='rank']">
			<tr class="medalRow">
	...
	<!-- add  age -->
	<xsl:template mode="RNOfficer" match="emph[@altrender='date']">
			<tr class="medalRow">
  ...
  <!-- add Date of Birth -->
  <xsl:template mode="RNOfficer" match="emph[@altrender='doe']">
    <tr class="medalRow">
