...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template name="colltype">
    <xsl:choose>
      ...
      <xsl:when test="(colltype/@id = 'FameWill') or (colltype/@id = 'Miscellaneous') or (colltype/@id = 'Miscellaneous')                 or (colltype/@id = 'Opening2002') or (colltype/@id = 'MapPicture') or (colltype/@id = 'Opening2003')                 or (colltype/@id = 'APS')">
        <xsl:apply-templates/>
      </xsl:when>
