<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<!-- ignore 'doctype' text (should be 'WA') -->
	<xsl:template mode="WomensCorps" match="emph[@altrender='doctype']">
	</xsl:template>
	
	<!-- Display lastname, firstname -->
	<xsl:template mode="WomensCorps" match="persname">
		<tr class="medalRow">
			<td class="medalplain" width="30%"><xsl:text disable-output-escaping="yes">Record for </xsl:text></td>
	...
	<!-- add Corps -->
	<xsl:template mode="WomensCorps" match="geogname">
			<tr class="medalRow">
  ...
  <!-- add Date of Birth -->
  <xsl:template mode="WomensCorps" match="emph[@altrender='dob']">
    <tr class="medalRow">
