...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="emph[@altrender='num']">
    <tr class="medalRow">
      <td class="medalplain" width="30%">
        <xsl:text disable-output-escaping="yes">  Squadron Number:  </xsl:text>
      </td>
  ...
  <xsl:template match="emph[@altrender='sum']">
    <tr class="medalRow">
      <td class="medalplain" width="30%">
        <xsl:text disable-output-escaping="yes">  Summary of Events:  </xsl:text>
      </td>
      <td class="medalplain" width="60%">
        <xsl:value-of disable-output-escaping="yes" select="text()"/>
      </td>
  ...
  <xsl:template match="emph[@altrender='rec']">
    <tr class="medalRow">
      <td class="medalplain" width="30%">
        <xsl:text disable-output-escaping="yes">  Records of Events:  </xsl:text>
      </td>
      <td class="medalplain" width="60%">
        <xsl:value-of disable-output-escaping="yes" select="text()"/>
      </td>
  ...
  <xsl:template match="emph[@altrender='append']">
    <tr class="medalRow">
      <td class="medalplain" width="30%">
        <xsl:text disable-output-escaping="yes">  Appendices:  </xsl:text>
      </td>
      <td class="medalplain" width="60%">
        <xsl:value-of disable-output-escaping="yes" select="text()"/>
      </td>
  ...
  <xsl:template match="emph[@altrender='comments']">
    <tr class="medalRow">
      <td class="medalplain" width="30%">
        <xsl:text disable-output-escaping="yes">  Comments:  </xsl:text>
      </td>
      <td class="medalplain" width="60%">
        <xsl:value-of disable-output-escaping="yes" select="text()"/>
      </td>
