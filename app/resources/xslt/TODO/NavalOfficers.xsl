<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<!-- ignore 'doctype' text (should be 'NO') -->
	<xsl:template mode="NavalOfficers" match="emph[@altrender='doctype']">
	</xsl:template>


	<!-- Display lastname, firstname -->
	<xsl:template mode="NavalOfficers" match="persname">
		<tr class="medalRow">
	...
	<!-- add Rank -->
	<xsl:template mode="NavalOfficers" match="emph[@altrender='rank']">
			<tr class="medalRow">
	...
	<!-- add Number -->
	<xsl:template mode="NavalOfficers" match="emph[@altrender='num']">
			<tr class="medalRow">
	...
	<!-- add Place of Birth -->
	<xsl:template mode="NavalOfficers" match="geogname">
			<tr class="medalRow">
			<td class="medalplain"> Place of Birth: </td>
			<td class="medalplain"><xsl:value-of select="text()" />
		</td></tr>
	</xsl:template>

  <!-- add Date of Birth -->
  <xsl:template mode="NavalOfficers" match="emph[@altrender='dob']">
    <tr class="medalRow">
