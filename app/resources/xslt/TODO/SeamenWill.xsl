<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template mode="SeamenWill" match="emph[@altrender='doctype']">
	<!--tr class="medalRow"-->
	...
	<!-- show title and " "-->
	<xsl:template mode="SeamenWill" match="persname">
	<!--tr class="medalRow"-->
	...
	<!-- add Rank -->
	<xsl:template mode="SeamenWill" match="emph[@altrender='rank']">
		<tr class="medalRow">
	...
	<!-- add Ship Name -->
	<xsl:template mode="SeamenWill" match="corpname">
		<tr class="medalRow">
	...
	<xsl:template mode="SeamenWill" match="emph[@altrender='num']">
		<tr class="medalRow">
	...
	<!-- add Date of will -->
	<xsl:template mode="SeamenWill" match="emph[@altrender='date']">
		<tr class="medalRow">
