<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="version">
		<!--
		VERSION CONTROL	RAFOfficers_SimpleScope_XSL XSL STYLESHEET
	...
	<!-- ignore 'doctype' text (should be 'RO') -->
	<xsl:template mode="RAFOfficers" match="emph[@altrender='doctype']">
	</xsl:template>

	<!-- Display lastname, firstname -->
	<xsl:template mode="RAFOfficers" match="persname">
		<tr class="medalRow">
  ...
  <!-- add Date of Birth -->
  <xsl:template mode="RAFOfficers" match="emph[@altrender='dob']">
    <tr class="medalRow">
