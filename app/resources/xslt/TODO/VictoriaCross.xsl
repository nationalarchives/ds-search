<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="version">
		...
		<xsl:template mode="VictoriaCross" match="emph[@altrender='doctype']">
		</xsl:template>
	
		<!-- Display lastname, firstname -->
		<xsl:template mode="VictoriaCross" match="persname">
			<tr class="medalRow">
				<td class="medalplain" width="35%"><xsl:text disable-output-escaping="yes">Victoria&amp;nbsp;Cross&amp;nbsp;details&amp;nbsp;of&amp;nbsp;</xsl:text></td>
		...
		<!-- add Rank -->
				<xsl:template mode="VictoriaCross" match="emph[@altrender='rank']">
						<tr class="medalRow">
				...
				<!-- add Corps -->
				<xsl:template mode="VictoriaCross" match="corpname">
						<tr class="medalRow">
				...
				<!-- add Date -->
				<xsl:template mode="VictoriaCross" match="emph[@altrender='date']">
							<tr class="medalRow">
				...
				<!-- add Campaign -->
					<xsl:template mode="VictoriaCross" match="emph[@altrender='campaign']">
							<tr class="medalRow">
				...
				<!-- add Corps -->
				<xsl:template mode="VictoriaCross" match="geogname">
						<tr class="medalRow">
